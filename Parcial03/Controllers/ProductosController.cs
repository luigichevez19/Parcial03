...
namespace Parcial03.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_Pro,nombre,stock,valor")] Productos productos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_Pro,nombre,stock,valor")] Productos productos)
        {
            if (ModelState.IsValid)
            {
